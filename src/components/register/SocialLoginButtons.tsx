...
interface SocialLoginButtonsProps {
  onOAuthRegister: (provider: "google" | "twitter") => void;
}

export const SocialLoginButtons: React.FC<SocialLoginButtonsProps> = ({ onOAuthRegister }) => {
  return (
    <div>
